...
const Section = ({ title, href, lien,list}) => {
  return (
      ...
      <div className="w-full ">
        <div className="flex flex-col items-center ">
          ...
          <p className="text-white py-5 ">
            Envie de nos services ? nous sommes à votre écoute
          </p>
          <Link
            to={href}
        ...
        <div className="md:flex justify-between pl-5 text-zinc-400 mt-20   ">
          <div className=" flex-1 h-3/6 bg-gray-700 rounded-3xl p-4 w-[95%] max-sm:mb-4 ">
            <h1
              className="p-4 underline decoration-1 text-2xl text-center "
              data-aos="fade-left"
            ...
            <p className="leading-8 w-[80%]">
              <strong className="text-white flex items-baseline ">
                Nettoyage de vitre:
              </strong>{" "}
              Nous utilisons des méthodes efficaces et respectueuses de
              l'environnement pour garantir des vitres propres et sans traces.
            </p>
            <p className="leading-8 py-3 w-[80%]">
              <strong className="text-white">Nettoyage de sol:</strong>
              <br></br> Nous utilisons des produits et des méthodes respectueux
              de la nature dans nos services. Nous favorisons l'utilisation de
          ...
          <div className=" flex-1 h-3/6 bg-gray-700 rounded-3xl p-4 my:0 w-[95%]  md:ml-4  max-sm:mb-4">
            ...
            <p className="leading-8  w-[80%]">
              ...
              <br></br> Nous proposons une gamme complète de services pour
              l'entretien des espaces extérieurs, y compris la tonte de gazon,
              la taille des arbres et arbustes, l'élagage, la plantation de
              fleurs et d'arbres, l'arrosage, la gestion des déchets verts, et
              bien plus encore.
            </p>
            {list}
            <p className="leading-8  w-[80%]">
              <strong className="text-white">
                Gestions et évacuations des déchets:
              </strong>{" "}
              <br></br> Nous valorisons les déchets de bois vert, comme de bois
              mort issus de la taille et de l'élagage, pour être réduits en
              copeaux et etre utilisés en broyat.
            </p>
          </div>
        </div>
      </div>
