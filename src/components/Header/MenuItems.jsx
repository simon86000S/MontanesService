      ...
      {links.map((link) => (
        <div>
          <div className="px-3 text-left md:cursor-pointer group   ">
            <h1
              className="  text-lg text-blue-900 font-semibold hover:text-sky-600  py-7 flex justify-between items-center md:pr-0 pr-5 group cursor-pointer max-[600px]:hover:text-white  duration-300 ease-in-out  font-normal max-lg:text-white "
              onClick={() => {
